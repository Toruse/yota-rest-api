    ...
    <div class="b-yota-app__b_1">
        <div class="inner-wrapper">
            <div class="b-yota-app__b_1_title">
                <div class="row-1">Yota для планшета</div>
    ...
    <div class="b-yota-app__b_2">
        <div class="inner-wrapper">
            <div class="b-yota-app__b_2_left">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/styles-app/icon-table-1.png" alt="">
            </div>
                        ...
                        <div class="b-yota-app__b_2_text">
                            ...
                            <div class="row-2">                                        <?php
                                if (isset($params['type'])) {
                                    switch ($params['type']){
                                        case 'day':
                                            echo $models['day'].' р.<span> на день</span>';
                                            break;
                                        case 'month':
                                            echo $models['month'].' р.<span> на 30 дней</span>';
                                            break;
                                        case 'year':
                                            echo $models['year'].' р.<span> на год</span>';
                                            break;
                                    }
                                } else {
                                    echo $models['month'].' р.<span> на 30 дней</span>';
