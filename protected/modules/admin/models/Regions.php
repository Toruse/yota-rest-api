 ...
 * @property Desktops[] $desktops
 * @property Phones[] $phones
 * @property Tablets[] $tablets
 */
class Regions extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'desktops' => array(self::HAS_MANY, 'Desktops', 'id_region'),
			'phones' => array(self::HAS_MANY, 'Phones', 'id_region'),
			'tablets' => array(self::HAS_MANY, 'Tablets', 'id_region'),
		);
	}
